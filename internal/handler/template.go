...
func (h *TemplateHandler) ThemeSettingsUpdate(w http.ResponseWriter, r *http.Request) {
	...
	validThemes := map[string]bool{"light": true, "dark": true, "sunny": true, "cozy": true, "grounded": true, "starfall": true, "silverglade": true, "seamist": true, "irondeep": true, "horsemark": true, "citadel": true, "imperial": true, "defiance": true, "ascendant": true, "starbridge": true}
