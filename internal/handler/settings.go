...
func NewSettingsHandler(ss *store.SettingsStore, ws *weather.Service, bm *backup.Manager, hub *websocket.Hub) *SettingsHandler {
	return &SettingsHandler{settingsStore: ss, weatherSvc: ws, backupManager: bm, hub: hub}
}
